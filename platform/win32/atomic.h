...
#ifndef NSYNC_PLATFORM_WIN32_ATOMIC_H_
#define NSYNC_PLATFORM_WIN32_ATOMIC_H_
...
#define ATM_MB_()  MemoryBarrier ()

#if ATM_LD_IS_ACQ_ST_IS_REL_
#define ATM_CB_() _ReadWriteBarrier ()   /* compiler barrier */
...
#define ATM_CAS_ACQ(p,o,n)    (atm_cas_barrier_u32_ ((p),(o),(n)))
#define ATM_CAS_REL(p,o,n)    (atm_cas_barrier_u32_ ((p),(o),(n)))
#define ATM_CAS_RELACQ(p,o,n) (atm_cas_barrier_u32_ ((p),(o),(n)))
...
#endif /*NSYNC_PLATFORM_WIN32_ATOMIC_H_*/
